  ...
  return (
    <div className="relative">
      <select
        ...
        className="appearance-none rounded-xl border border-slate-200 bg-white px-3 py-2 pr-9 text-sm outline-none focus:border-slate-400"
      >
        {children}
      </select>
 ...
 *
 * También se transmite el estado al elemento HTML
 * <button> y se aplica una apariencia visual adecuada.
 * ========================================================= */
